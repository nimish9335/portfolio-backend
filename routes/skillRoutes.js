...
router.post("/",protect,imageUpload.single("icon"),createSkillValidator,validate,createSkill);
router.put("/:id",protect,validateObjectId("id"),imageUpload.single("icon"),updateSkillValidator,validate,updateSkill);
