...
router.post("/",protect,imageUpload.single("thumbnail"),createProjectValidator,validate,createProject);
router.get("/", getAllProjects);
router.get("/:id",validateObjectId(),validate,getProjectById);
router.put("/:id",protect,imageUpload.single("thumbnail"),validateObjectId(),createProjectValidator,validate,updateProject);
